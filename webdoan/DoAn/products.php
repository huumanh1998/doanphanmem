    ...
    <div class="content">
    	<div class="content_top">
	      ...
	      <div class="section group">
			...
			<div class="section group">
				<?php 
				$getLastestOP = $product->getLastestOppopro();
				if($getLastestOP){
					while($resultop = $getLastestOP->fetch_assoc()){
				?>
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="details.php"><img src="admin/uploads/<?php echo $resultop["image"] ?>" alt="" /></a>
					 <h2><?php echo $resultop["productName"] ?></h2>
					 <!-- <p><?php echo $fm->textShorten($resultop["product_desc"], 350) ?></p> -->
					 <p><span class="price"><?php echo $fm->format_currency($resultop["price"])." "."VND" ?></span></p>
				     <div class="button"><span><a href="details.php?proid=<?php echo $resultop['productId'] ?>" class="details">Chi tiết</a></span></div>
				</div>
				<?php 
				} 
				}
			...
			<div class="section group">
				...
				?>
				<div class="grid_1_of_4 images_1_of_4">
					 <a href="details.php"><img src="admin/uploads/<?php echo $resultxm["image"] ?>" alt="" /></a>
					 <h2><?php echo $resultxm["productName"] ?></h2>
					 <!-- <p><?php echo $fm->textShorten($resultxm["product_desc"], 350) ?></p> -->
					 <p><span class="price"><?php echo $fm->format_currency($resultxm["price"])." "."VND" ?></span></p>
				     <div class="button"><span><a href="details.php?proid=<?php echo $resultxm['productId'] ?>" class="details">Chi tiết</a></span></div>
				</div>
				<?php 
				} 
				}
		...
		<div class="content_bottom">
			...
			<div class="section group">
				<?php 
				$getLastestXM = $product->getLastestNokia();
				if($getLastestXM){
					while($resultxm = $getLastestXM->fetch_assoc()){
				?>
				<div class="grid_1_of_4 images_1_of_4">
