...
<?php
	...
	class customer
	{
		...
		public function insert_binhluan(){
			...
			$tensanpham = $_POST['tencuasanpham'];
			$binhluan = $_POST['binhluan'];
			if($tenbinhluan=='' || $tensanpham==''|| $binhluan==''){
				$alert = "<span class='error'>Không để trống các trường</span>";
				return $alert;
			}else{
				$query = "INSERT INTO tbl_binhluan(tenbinhluan,tensanpham,binhluan,product_id) VALUES('$tenbinhluan','$tensanpham','$binhluan','$product_id')";
		...
		public function insert_contact(){
			...
			if($contactName=='' || $contactEmail==''|| $contactPhone==''|| $contactDesc==''){
				$alert = "<span class='error'>Không để trống các trường</span>";
				return $alert;
			}else{
				$query = "INSERT INTO tbl_contact(contactName,contactEmail,contactPhone,contactDesc,contactId) VALUES('$contactName','$contactEmail','$contactPhone','$contactDesc','$contactId')";
					$result = $this->db->insert($query);
					if($result){
						$alert = "<span class='success'>Ý kiến đã gửi</span>";
						return $alert;
					}else{
